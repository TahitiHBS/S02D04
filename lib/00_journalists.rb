...
puts "avec un chiffre compte final #{cpt}"
end
...
puts "avec aude compte final #{cpt}"
end
...
listest[n][1]
	...
	#end
puts "avec Maj compte final #{cpt}"
end
...
puts "chiffre"
#print liste
journalist = extractionchiffre(liste)suc
puts "aude"
print liste
aude(liste)
print liste
